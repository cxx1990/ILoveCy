...
window.onload = function(){
    ...
    setInterval(
        function(){
            ...
            update();//对显示数据的更新
               preImage("cxx.jpg",function(){  
        context.beginPath();
        context.drawImage(this,0,((WINDOW_HEIGHT/3)*2),WINDOW_WIDTH,WINDOW_HEIGHT/3);  
         context.closePath();
    });  
        }
        ,
...
function getCurrentShowTimeSeconds() {
    ...
    var  time= parseInt(ret%(1000*60*60*24));
...
function updateBalls(){
	...
	balls[i].vy += c * balls[i].g;;
        ...
        if( balls[i].y >= (WINDOW_HEIGHT*2)/3-RADIUS ){
            balls[i].y = (WINDOW_HEIGHT*2)/3-RADIUS;
